...
func NewMarket() *Market {
	...
	rules := []string{
		...
		/*
		`>Oil<`, any, price, any, price, any,
		`>Yen<`, any, price, any, price, any,
		`>Euro<`, any, price, any, price, any,
		`>Gold<`, any, price, any, price, any,
...
func (market *Market) extract(snippet []byte) *Market {
	...
	market.Dow[`percent`] = matches[1]
	market.Dow[`latest`] = matches[2]
	market.Dow[`change`] = matches[3]

	market.Nasdaq[`percent`] = matches[4]
	market.Nasdaq[`latest`] = matches[5]
	market.Nasdaq[`change`] = matches[6]

	market.Sp500[`percent`] = matches[7]
	market.Sp500[`latest`] = matches[8]
	market.Sp500[`change`] = matches[9]
...
/*
	...
	market.Tokyo[`percent`] = matches[20]
	market.Tokyo[`latest`] = matches[21]
	market.Tokyo[`change`] = matches[22]

	market.HongKong[`percent`] = matches[23]
	market.HongKong[`latest`] = matches[24]
	market.HongKong[`change`] = matches[25]

	market.London[`percent`] = matches[26]
	market.London[`latest`] = matches[27]
	market.London[`change`] = matches[28]

	market.Frankfurt[`percent`] = matches[29]
	market.Frankfurt[`latest`] = matches[30]
	market.Frankfurt[`change`] = matches[31]
 */
	return market
}
